            ...
            <div class="posts col-9">
                ...
                <div class="row add-post">
                    ...
                    <div class="col">
                        ...
                        <input name="login" value="<?=$login;?>" type="text" class="form-control" id="formGroupExampleInput" placeholder="User login name">
                    </div>

                    <div class="col">
                        <label for="exampleInputEmail1" class="form-label">Email address</label>
                        <input name="mail" readonly type="email" value="<?=$email?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    ...
                    <div class="col">
                        <button name="update-user" class="btn btn-primary" type="submit">Update user</button>
                    </div>
